...
class Plugin
{
    ...
    public static function register_widget_styles()
    {
        ...
        wp_enqueue_style('swiper', \RomeTheme::widget_url() . 'assets/css/swiper-bundle.min.css', '', \RomeTheme::rt_version());
    ...
    public static function register_widget_scripts()
    {
        ...
        wp_enqueue_script('swiperjs', \RomeTheme::widget_url() . 'assets/js/swiper-bundle.min.js',  [], \RomeTheme::rt_version(), true);
...
<?php
    ...
    public static function register_icon_pack_to_elementor($font)
    {
        ...
        $font_new['rtmicons'] = array(
            ...
            'url'           => \RomeTheme::plugin_url() . 'assets/css/style.css',
            'prefix'        => 'rtmicon-',
            'displayPrefix' => 'rtmicon',
            'labelIcon'     => 'rtmicon rtmicon-rometheme',
            'ver'           => '1.3.1',
            'fetchJson'     => \RomeTheme::plugin_url() . 'assets/js/new-selections.json',
            'native'        => true,
        );
    ...
    {
        wp_enqueue_style('elementor-icons-rtmicon', \RomeTheme::plugin_url() . 'assets/css/style.css', '', \RomeTheme::rt_version());
