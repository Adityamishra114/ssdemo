...
class RomeTheme
{
	...
	function register_style()
	{
		...
		if ($screen->id == 'toplevel_page_romethemekit' || $screen->id == 'romethemekit_page_themebuilder' || $screen->id == 'romethemekit_page_rkit-system-status' || $screen->id == 'romethemekit_page_rkit-widgets') {
			wp_enqueue_style('style.css', self::plugin_url() . 'bootstrap/css/bootstrap.css');
			wp_enqueue_script('bootstrap.js', self::plugin_url() . 'bootstrap/js/bootstrap.min.js');
		}
	}
